...
const WindowManager = {
    ...
    MULTI_WINDOW_APP_IDS: new Set(['files', 'notes', 'browser', 'terminal']),
    MULTI_WINDOW_LAUNCH_SOURCES: new Set(['desktop', 'start-menu']),
    _componentTemplates: new Map(),
    ...
    appConfigs: {
        files: { titleKey: 'files.title', icon: 'Theme/Icon/App_icon/files.webp', width: 900, height: 600, component: 'FilesApp' },
        settings: { titleKey: 'settings.title', icon: 'Theme/Icon/App_icon/settings.webp', width: 950, height: 650, component: 'SettingsApp' },
        'process-manager': { titleKey: 'processManager.title', icon: 'Theme/Icon/App_icon/Taskmgr.webp', width: 980, height: 660, minWidth: 680, minHeight: 480, component: 'ProcessManagerApp' },
        'developer-center': { titleKey: 'developerCenter.title', icon: 'Theme/Icon/App_icon/developer_center.webp', width: 1120, height: 720, minWidth: 720, minHeight: 520, component: 'DeveloperCenterApp' },
        'app-installer': { title: 'Nyou App安装工具', icon: 'Theme/Icon/App_icon/App_package.webp', width: 720, height: 560, minWidth: 600, minHeight: 470, component: 'AppInstallerApp' },
        terminal: { titleKey: 'terminal.title', icon: 'Theme/Icon/App_icon/terminal.webp', width: 900, height: 600, minWidth: 560, minHeight: 360, component: 'TerminalApp' },
        tips: { titleKey: 'tips.title', icon: 'Theme/Icon/App_icon/tips.webp', width: 1120, height: 720, minWidth: 760, minHeight: 520, component: 'TipsApp' },
        calculator: { titleKey: 'calculator.title', icon: 'Theme/Icon/App_icon/calculator.webp', width: 760, height: 620, minWidth: 520, minHeight: 500, component: 'CalculatorApp' },
        notes: { titleKey: 'notes.title', icon: 'Theme/Icon/App_icon/notes.webp', width: 920, height: 640, minWidth: 560, minHeight: 420, component: 'NotesApp' },
        browser: { titleKey: 'browser.title', icon: 'Theme/Icon/App_icon/browser.webp', width: 1000, height: 700, component: 'BrowserApp' },
        clock: { titleKey: 'clock.title', icon: 'Theme/Icon/App_icon/clock.webp', width: 900, height: 650, component: 'ClockApp' },
        weather: { titleKey: 'weather.title', icon: 'Theme/Icon/App_icon/weather.webp', width: 920, height: 640, component: 'WeatherApp' },
        appshop: { titleKey: 'appshop.title', icon: 'Theme/Icon/App_icon/app_gallery.webp', width: 1000, height: 700, component: 'AppShop' },
        camera: { titleKey: 'camera.title', icon: 'Theme/Icon/App_icon/camera.webp', width: 1100, height: 720, minWidth: 760, minHeight: 520, component: 'CameraApp' },
        photos: { titleKey: 'photos.title', icon: 'Theme/Icon/App_icon/photos.webp', width: 1000, height: 700, component: 'PhotosApp' },
        media: { titleKey: 'media.title', icon: 'Theme/Icon/App_icon/media.webp', width: 980, height: 640, minWidth: 640, minHeight: 360, component: 'MediaApp' },
        clipboard: { title: '剪贴板历史', icon: 'Theme/Icon/Symbol_icon/stroke/Copy.svg', width: 420, height: 520, minWidth: 320, minHeight: 400, component: 'ClipboardApp' },
        'password-gen': { title: '密码生成器', icon: 'Theme/Icon/Symbol_icon/stroke/Lock.svg', width: 360, height: 340, minWidth: 300, minHeight: 280, component: 'PasswordGenApp' },
        'qr-generator': { title: 'QR 生成器', icon: 'Theme/Icon/Symbol_icon/stroke/Scan.svg', width: 380, height: 480, minWidth: 320, minHeight: 400, component: 'QRGeneratorApp' },
        'unit-converter': { title: '单位转换器', icon: 'Theme/Icon/Symbol_icon/stroke/Exchange A.svg', width: 420, height: 480, minWidth: 340, minHeight: 380, component: 'UnitConverterApp' },
        'system-monitor': { title: '系统监控', icon: 'Theme/Icon/Symbol_icon/stroke/Dashboard.svg', width: 450, height: 400, minWidth: 350, minHeight: 300, component: 'SystemMonitorApp' },
        'todo': { title: '待办事项', icon: 'Theme/Icon/Symbol_icon/stroke/Check.svg', width: 400, height: 500, minWidth: 320, minHeight: 400, component: 'TodoApp' },
        'wallpaper-manager': { title: '壁纸管理', icon: 'Theme/Icon/Symbol_icon/stroke/Image.svg', width: 500, height: 400, minWidth: 400, minHeight: 300, component: 'WallpaperManagerApp' },
        'file-search': { title: '文件搜索', icon: 'Theme/Icon/Symbol_icon/stroke/Search.svg', width: 500, height: 400, minWidth: 400, minHeight: 300, component: 'FileSearchApp' },
        'screenshot': { title: '截图工具', icon: 'Theme/Icon/Symbol_icon/stroke/Camera.svg', width: 500, height: 400, minWidth: 400, minHeight: 300, component: 'ScreenshotApp' },
        'notification-manager': { title: '通知管理', icon: 'Theme/Icon/Symbol_icon/stroke/Bell.svg', width: 400, height: 500, minWidth: 320, minHeight: 400, component: 'NotificationManagerApp' },
        'shortcut-manager': { title: '快捷方式', icon: 'Theme/Icon/Symbol_icon/stroke/Star.svg', width: 500, height: 400, minWidth: 400, minHeight: 300, component: 'ShortcutManagerApp' },
        'virtual-desktop': { title: '虚拟桌面', icon: 'Theme/Icon/Symbol_icon/weather/cloud-moon-64px.svg', width: 350, height: 300, minWidth: 280, minHeight: 240, component: 'VirtualDesktopApp' },
        'performance': { title: '性能分析', icon: 'Theme/Icon/Symbol_icon/stroke/Bell.svg', width: 400, height: 350, minWidth: 320, minHeight: 280, component: 'PerformanceApp' },
        'developer': { title: '开发者工具', icon: 'Theme/Icon/Symbol_icon/stroke/Bell.svg', width: 600, height: 450, minWidth: 480, minHeight: 360, component: 'DeveloperApp' },
        'screen-recorder': { title: '屏幕录制', icon: 'Theme/Icon/Symbol_icon/stroke/Bell.svg', width: 500, height: 400, minWidth: 400, minHeight: 300, component: 'ScreenRecorderApp' },
        'notes2': { title: '笔记', icon: 'Theme/Icon/Symbol_icon/stroke/Note.svg', width: 450, height: 500, minWidth: 360, minHeight: 400, component: 'NotesApp2' },
        'launcher': { title: '启动器', icon: 'Theme/Icon/Symbol_icon/stroke/Bell.svg', width: 600, height: 500, minWidth: 480, minHeight: 400, component: 'LauncherApp' },
        'theme-editor': { title: '主题编辑器', icon: 'Theme/Icon/Symbol_icon/stroke/Bell.svg', width: 500, height: 400, minWidth: 400, minHeight: 300, component: 'ThemeEditorApp' },
        'color-picker': { title: '颜色选择器', icon: 'Theme/Icon/Symbol_icon/stroke/Color Picker.svg', width: 350, height: 350, minWidth: 280, minHeight: 280, component: 'ColorPickerApp' },
        'qr-generator': { title: '二维码生成器', icon: 'Theme/Icon/Symbol_icon/stroke/Scan.svg', width: 350, height: 400, minWidth: 280, minHeight: 320, component: 'QRGeneratorApp' },
        'password-gen': { title: '密码生成器', icon: 'Theme/Icon/Symbol_icon/stroke/Lock.svg', width: 350, height: 300, minWidth: 280, minHeight: 240, component: 'PasswordGenApp' },
        'color-picker': { title: '颜色选择器', icon: 'Theme/Icon/Symbol_icon/stroke/Color Picker.svg', width: 360, height: 420, minWidth: 300, minHeight: 340, component: 'ColorPickerApp' },
        'theme-editor': { title: '主题编辑器', icon: 'Theme/Icon/Symbol_icon/stroke/Color Swatch.svg', width: 480, height: 520, minWidth: 380, minHeight: 420, component: 'ThemeEditorApp' },
        'screen-recorder': { title: '屏幕录制', icon: 'Theme/Icon/Symbol_icon/stroke/Video.svg', width: 480, height: 360, minWidth: 380, minHeight: 300, component: 'ScreenRecorderApp' },
        developer: { title: '开发者工具', icon: 'Theme/Icon/Symbol_icon/stroke/Terminal.svg', width: 640, height: 480, minWidth: 480, minHeight: 360, component: 'DeveloperApp' },
        launcher: { title: '应用启动器', icon: 'Theme/Icon/Symbol_icon/stroke/Layout Grid.svg', width: 400, height: 500, minWidth: 320, minHeight: 400, component: 'LauncherApp' },
        notes2: { title: '便签', icon: 'Theme/Icon/App_icon/notes.webp', width: 400, height: 500, minWidth: 300, minHeight: 380, component: 'NotesApp2' },
        calendar: { title: '日历', icon: 'Theme/Icon/Symbol_icon/stroke/Calendar.svg', width: 520, height: 560, minWidth: 420, minHeight: 440, component: 'CalendarApp' },
        'document-editor': { title: '文档编辑器', icon: 'Theme/Icon/Symbol_icon/stroke/Book Text.svg', width: 900, height: 650, minWidth: 600, minHeight: 450, component: 'DocumentEditorApp' },
        pomodoro: { title: '番茄钟', icon: 'Theme/Icon/Symbol_icon/stroke/Timer.svg', width: 380, height: 520, minWidth: 320, minHeight: 440, component: 'PomodoroApp' },
        'sticky-notes': { title: '便签', icon: 'Theme/Icon/Symbol_icon/stroke/Note.svg', width: 560, height: 480, minWidth: 420, minHeight: 360, component: 'StickyNotesApp' }
    },
    ...
    _cloneComponentValue(value, seen = new WeakMap()) {
        if (value === null || typeof value !== 'object') return value;
        if (seen.has(value)) return seen.get(value);
        if (value instanceof Date) return new Date(value.getTime());
        if (value instanceof Set) return new Set(Array.from(value, (item) => this._cloneComponentValue(item, seen)));
        if (value instanceof Map) {
            const map = new Map();
            seen.set(value, map);
            value.forEach((item, key) => map.set(key, this._cloneComponentValue(item, seen)));
            return map;
        }
        ...
        if (Array.isArray(value)) {
            ...
            value.forEach((item) => array.push(this._cloneComponentValue(item, seen)));
            return array;
        }
        ...
        Reflect.ownKeys(value).forEach((key) => {
            object[key] = this._cloneComponentValue(value[key], seen);
        });
        return object;
    },

    _captureMultiWindowComponentTemplates() {
        this.MULTI_WINDOW_APP_IDS.forEach((appId) => {
            const config = this.appConfigs[appId];
            const component = config?.component ? globalThis[config.component] : null;
            if (!component || this._componentTemplates.has(appId)) return;
            const template = {};
            Reflect.ownKeys(component).forEach((key) => {
                const value = component[key];
                template[key] = typeof value === 'function' ? value : this._cloneComponentValue(value);
            });
            this._componentTemplates.set(appId, template);
        });
    },

    _createComponentInstance(appId, fallbackComponent) {
        const template = this._componentTemplates.get(appId);
        if (!template) return fallbackComponent;
        const instance = {};
        Reflect.ownKeys(template).forEach((key) => {
            const value = template[key];
            instance[key] = typeof value === 'function' ? value : this._cloneComponentValue(value);
        });
        return instance;
    },
    ...
    init() {
        ...
        this._captureMultiWindowComponentTemplates();
        ...
        State.on('settingsChange', (updates) => {
            ...
            if (Object.prototype.hasOwnProperty.call(updates, 'enableAppMultiWindow')) {
    ...
    _setTombstoneClasses(windowData, frozen) {
        ...
        el.querySelectorAll('iframe').forEach((frame) => {
            if (frozen) {
                frame.dataset.NyouFrozen = 'true';
            } else {
                delete frame.dataset.NyouFrozen;
            }
        });
    },
    ...
    _freezeWindow(windowData) {
        ...
        try {
            windowData.element.dispatchEvent(new CustomEvent('nyou-window-freeze', {
    ...
    _restoreWindowFromTombstone(windowData) {
        ...
        if (windowData.element) {
            try {
                windowData.element.dispatchEvent(new CustomEvent('nyou-window-restore-from-freeze', {
                    detail: { appId: windowData.appId, windowId: windowData.id, isPWA: this._isPWAWindow(windowData) }
                }));
            } catch (_) {
    ...
    _setTaskbarIndicatorForWindow(windowData, forceActive = false) {
        ...
        void forceActive;
        this._syncTaskbarAppState(windowData.appId);
    },

    _syncTaskbarAppState(appId) {
        const taskbarBtn = document.querySelector(`.taskbar-app[data-app-id="${appId}"]`);
        if (!taskbarBtn) return;
        const appWindows = this.getAppWindows(appId);
        const isRunning = appWindows.length > 0;
        const allMinimized = isRunning && appWindows.every((item) =>
            item.isMinimized === true || item.isMinimizing === true || item.element?.style.display === 'none'
        );
        const isActive = appWindows.some((item) =>
            item.id === this.activeWindowId
            && item.isMinimized !== true
            && item.isMinimizing !== true
            && item.element?.style.display !== 'none'
        );

        taskbarBtn.classList.toggle('running', isRunning);
        taskbarBtn.classList.toggle('taskbar-app-minimized', allMinimized);
        taskbarBtn.classList.toggle('taskbar-app-active', isActive);
        taskbarBtn.classList.toggle('taskbar-app-multi', State.settings.enableAppMultiWindow === true && appWindows.length > 1);
        taskbarBtn.dataset.windowCount = String(appWindows.length);
        if (typeof Taskbar !== 'undefined' && typeof Taskbar.syncAppIndicator === 'function') {
            Taskbar.syncAppIndicator(appId);
        }
    },
    ...
    getAppWindow(appId) {
        ...
        const active = appWindows.find((item) => item.id === this.activeWindowId);
        if (active) return active;
        for (let index = this.focusHistory.length - 1; index >= 0; index -= 1) {
            const match = appWindows.find((item) => item.id === this.focusHistory[index]);
            if (match) return match;
        }
        return appWindows.sort((a, b) => (Number(b.element.style.zIndex) || 0) - (Number(a.element.style.zIndex) || 0))[0];
    },
    ...
    getAppComponent(appId) {
        ...
        if (windowData?.component) return windowData.component;
        const config = this.appConfigs[appId];
        return config?.component ? globalThis[config.component] : null;
    },
    ...
    _shouldCreateAdditionalWindow(appId, source, existingWindows) {
        return State.settings.enableAppMultiWindow === true
            && this.MULTI_WINDOW_APP_IDS.has(appId)
            && this.MULTI_WINDOW_LAUNCH_SOURCES.has(source)
            && existingWindows.length > 0;
    },

    _cascadeMultiWindowBounds(bounds, instanceIndex, appId) {
        if (instanceIndex <= 0) return bounds;
        const base = bounds?.lastNormalBounds || bounds;
        const offset = 28 * ((instanceIndex - 1) % 8 + 1);
        const width = Number(base?.width) || Number(bounds?.width) || 900;
        const height = Number(base?.height) || Number(bounds?.height) || 600;
        const viewportWidth = Math.max(width, globalThis.innerWidth || width);
        const viewportHeight = Math.max(height, globalThis.innerHeight || height);
        const maxLeft = Math.max(0, viewportWidth - width);
        const maxTop = Math.max(0, viewportHeight - height - 52);
        const left = Math.min(maxLeft, Math.max(0, (Number(base?.left) || 0) + offset));
        const top = Math.min(maxTop, Math.max(0, (Number(base?.top) || 0) + offset));
        return {
            ...this._clampWindowBounds({ left, top, width, height }, appId),
            snapLayout: null,
            lastNormalBounds: null
        };
    },

    openApp(appId, data = null, options = {}) {

        if (typeof SettingsApp !== 'undefined' && typeof SettingsApp.isAppRepairing === 'function' && SettingsApp.isAppRepairing(appId)) {
            NyouUI.Toast({
        ...
        const createdAppRuntime = globalThis.DeveloperCreatedRuntime;
        if (createdAppRuntime?.interceptLaunch?.(appId, data, options)) {
            return false;
        }
        ...
        // Taskbar and in-App launches activate the most recent window. Desktop
        // and Start may create another instance for the four opted-in Apps.
        const existingWindows = this.getAppWindows(appId);
        const source = String(options?.source || 'app');
        const createAdditionalWindow = this._shouldCreateAdditionalWindow(appId, source, existingWindows);
        const existingWindow = this.getAppWindow(appId);
        if (existingWindow && !createAdditionalWindow) {
        ...
        const rememberedBounds = this._readWindowBounds(appId, config);
        const initialBounds = this._cascadeMultiWindowBounds(rememberedBounds, existingWindows.length, appId);
        ...
        const baseComponent = config.component ? globalThis[config.component] : null;
        const component = existingWindows.length > 0
            ? this._createComponentInstance(appId, baseComponent)
            : baseComponent;
        const windowData = {
            id: windowId,
            appId: appId,
            ...
            launchSource: source,
            instanceNumber: existingWindows.length + 1
        };
    ...
    createWindow(windowId, appId, config, initialBounds = null) {
        ...
        windowElement.innerHTML = `
            <div class="window-mica-backdrop" aria-hidden="true"></div>
        ...
        this._installMicaBackdropTracking(windowElement);

        return windowElement;
    },

    _installMicaBackdropTracking(windowElement) {
        const backdrop = windowElement?.querySelector('.window-mica-backdrop');
        if (!backdrop || typeof requestAnimationFrame !== 'function') return;
        ...
        const syncPosition = () => {
            ...
            backdrop.style.setProperty('--mica-window-x', `${x.toFixed(2)}px`);
            backdrop.style.setProperty('--mica-window-y', `${y.toFixed(2)}px`);
        ...
        const trackPosition = (duration = 700) => {
            trackUntil = Math.max(trackUntil, performance.now() + duration);
            if (!frameId) frameId = requestAnimationFrame(syncPosition);
        };

        const mutationObserver = typeof MutationObserver === 'function'
            ? new MutationObserver(() => trackPosition())
            : null;
        mutationObserver?.observe(windowElement, {
            attributes: true,
            attributeFilter: ['style', 'class']
        });

        const resizeObserver = typeof ResizeObserver === 'function'
            ? new ResizeObserver(() => trackPosition())
            : null;
        resizeObserver?.observe(windowElement);

        const handleViewportResize = () => trackPosition();
        window.addEventListener('resize', handleViewportResize);

        windowElement._micaBackdropCleanup = () => {
    ...
    bindWindowEvents(windowElement) {
        ...
        document.addEventListener('pointermove', (e) => {
            ...
            if (typeof NyouWindow !== 'undefined' && typeof NyouWindow.refreshGlobalScrollbars === 'function') {
                NyouWindow.refreshGlobalScrollbars(windowElement);
            }
    ...
    focusWindow(windowId, options = {}) {
        ...
        if (typeof SurfAi !== 'undefined' && SurfAi && SurfAi.isOpen && typeof SurfAi._ensurePanelForeground === 'function') {
            SurfAi._ensurePanelForeground();
        }
    },
    ...
    closeWindow(windowId, options = {}) {
        ...
        const proceedClose = () => {
            ...
            this.updateMaximizedWallpaperEffect();
            setTimeout(() => {
                windowData.element._micaBackdropCleanup?.();
