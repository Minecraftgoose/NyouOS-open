...
const FingoData = {
    ...
    commands: {
        ...
        fingoSettings: {
            ...
            response: { zh: '正在打开 SurfAi 设置... 🤖', en: 'Opening SurfAi settings... 🤖' }
        },
        // ===== 介绍 NyouOS =====
        aboutNyouOS: {
            keywords: ['介绍NyouOS', '什么是NyouOS', 'NyouOS是什么', 'about NyouOS', 'what is NyouOS', '介绍系统', '关于系统'],
            action: 'none',
            response: { zh: 'NyouOS 是一个基于 Web 技术构建的模拟操作系统 💻\n\n✨ 采用 Nyou Design 设计语言\n🛠️ 纯 HTML5 + CSS3 + JavaScript 实现\n📱 内置文件管理、浏览器、天气、时钟等系统应用\n🛒 支持通过 App Shop 安装第三方应用\n🤖 集成 SurfAi 智能助手\n\n这是一个开源项目，欢迎体验和贡献！', en: 'NyouOS is a web-based simulated operating system 💻\n\n✨ Nyou Design language\n🛠️ Pure HTML5 + CSS3 + JavaScript\n📱 Built-in apps: Files, Browser, Weather, Clock, etc.\n🛒 App Shop for third-party apps\n🤖 SurfAi assistant\n\nIt\'s open source - feel free to explore and contribute!' }
        },
        // ===== 亮度 =====
        brightnessUp: {
            keywords: [
        ...
        // ===== Nyou V2 =====
        v2On: {
            keywords: ['新版外观', '启用v2', 'Nyou v2', 'new ui', 'enable v2'],
            action: 'setNyouV2:true',
            response: { zh: '已切换到新版外观 ✨', en: 'Switched to new UI ✨' }
        },
        v2Off: {
            keywords: ['经典外观', '关闭v2', 'classic ui', 'disable v2', '旧版外观'],
            action: 'setNyouV2:true',
            response: { zh: 'Nyou V2 已固定启用，经典外观不再可用。', en: 'Nyou V2 is fixed on; classic UI is no longer available.' }
        },
        // ===== 问候/帮助 =====
        greet: {
            ...
            response: {
                zh: [
                    '你好呀，我是 SurfAi 👋 你的系统搭子已上线！\n要不要我给你一份 30 秒新手指引？（是/否）',
                    '嗨～SurfAi 在这儿 ✨\n想快速熟悉 NyouOS 吗？回复「是」我马上带你上手。'
                ],
                en: [
                    'Hi, I am SurfAi 👋 Your system sidekick is ready.\nWant a 30-second quick-start guide? (yes/no)',
                    'Hey there ✨\nWant to learn NyouOS quickly? Reply "yes" and I will guide you.'
                ]
            }
        },
        help: {
        ...
        love: {
            ...
            action: 'none',
            response: {
                zh: ['收到 ❤️ 我会用稳定和好用来回应你。', '谢谢喜欢，我们一起把 NyouOS 用顺手。'],
                en: ['Love received ❤️ I will respond with useful actions.', 'Thanks. Let us make NyouOS smoother together.']
            }
        },
        // ===== 智能模式提示 =====
        suggestCustom: {
            ...
            response: {
                zh: [
                    '想让我更聪明？你可以在「设置 → SurfAi」中开启自定义模式，填入你的 API Key，我就能用大语言模型和你对话啦 🧠',
                    '如果你希望更像真人聊天，建议开启自定义模式并接入 API，我的理解能力会明显提升。'
                ],
                en: [
                    'Want me to be smarter? Enable custom mode in Settings → SurfAi with your API Key.',
        ...
        angry: {
            ...
            response: {
                zh: [
                    '别生气嘛 😅 我目前主要通过关键词匹配来回复。\n如果你想让我更智能，可以在「设置 → SurfAi」中开启自定义模式并填入 API Key。',
                ...
                en: [
                    ...
                    'Tell me the exact task you want to do in NyouOS, and I will execute it directly.'
                ]
            }
        }
    },
