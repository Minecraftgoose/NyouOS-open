/**
 * NyouOS Process Manager
 * Shows open apps alongside protected NyouOS core services.
 */
const ProcessManagerApp = {
    ...
    CORE_PROCESSES: [
        { id: 'shell-host', name: 'NyouOS Shell Host', icon: 'Home', pid: 104 },
        ...
        { id: 'nyou-ui-runtime', name: 'NyouUI Runtime', icon: 'Dashboard', pid: 524 },
    ...
    renderProcessPage(pageEl, mode) {
        ...
        const endTaskButton = NyouUI.Button({
    ...
    getAppProcesses() {
        ...
        return Array.from(byApp.entries()).map(([appId, windowData]) => {
            ...
            return {
                ...
                iconSrc: config.icon || desktopApp?.icon || 'Theme/Icon/App_icon/App_package.webp',
    ...
    getCoreProcesses() {
        return this.CORE_PROCESSES.map((process) => ({
            ...process,
            iconSrc: NyouWindow._iconPath(process.icon, 'stroke'),
    ...
    addStyles() {
        ...
        style.textContent = `
            ...
            .process-table-body > .Nyou-empty { padding: 54px 20px; }
            ...
            .process-settings-section .Nyou-setting-item { border: 1px solid var(--border-color); border-radius: var(--radius-lg); background: var(--bg-secondary); }
            .process-settings-section .Nyou-select-wrapper { min-width: 130px; }
