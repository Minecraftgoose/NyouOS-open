...
const BrowserApp = {
    ...
    init(windowId) {
        ...
        if (!this._favoriteSitesChangeHandler) {
            ...
            window.addEventListener('Nyou-favorite-sites-change', this._favoriteSitesChangeHandler);
        }
    },
    ...
    beforeClose() {
        ...
        if (this._favoriteSitesChangeHandler) {
            window.removeEventListener('Nyou-favorite-sites-change', this._favoriteSitesChangeHandler);
    ...
    renderTabs() {
        ...
        tabsContainer.querySelectorAll('.Nyou-tab, .Nyou-tab-close, .Nyou-tabbar-add').forEach((node) => {
    ...
    showFavoriteContextMenu(site, x, y) {
        ...
        this._favoriteContextMenu?.remove();
        if (!window.NyouUI?.ContextMenu) return;
        const menu = NyouUI.ContextMenu({
    ...
    attachIframeLinkInterception(iframe) {
        ...
        if (!iframeDoc || !iframeWindow || iframeDoc.__NyouBrowserLinksBound) return;
        iframeDoc.__NyouBrowserLinksBound = true;
    ...
    addStyles() {
        ...
        style.textContent = `
            ...
            .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tabbar-tabs {
                min-width: 0;
            }

            .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tab {
                min-width: 120px;
                max-width: 220px;
                border-radius: 10px;
            ...
            .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tab.active {
                background: rgba(255, 255, 255, 0.72);
                box-shadow: 0 1px 0 rgba(255, 255, 255, 0.28) inset;
            }

            .dark-mode .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tab {
                background: rgba(255, 255, 255, 0.06);
            }

            .dark-mode .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tab.active {
                background: rgba(255, 255, 255, 0.12);
                box-shadow: none;
            }

            .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tab-close,
            .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tabbar-add {
                opacity: 1;
            }

            body.Nyou-v2 .window[data-app-id="browser"] .window-titlebar {
                margin: 0;
                padding: 12px 14px;
            ...
            body.Nyou-v2.dark-mode .window[data-app-id="browser"] .window-titlebar {
                border-color: rgba(255, 255, 255, 0.08);
                background: rgba(34, 34, 34, 0.78) !important;
            }

            body.Nyou-v2 .window[data-app-id="browser"] .window-content {
                background: transparent;
            }

            body.Nyou-v2 .window[data-app-id="browser"] {
                --browser-float-radius: var(--radius-lg, 16px);
                border-radius: var(--browser-float-radius);
                overflow: hidden;
            }

            body.Nyou-v2 .window[data-app-id="browser"].maximized,
            body.Nyou-v2 .window[data-app-id="browser"].maximized .window-titlebar,
            body.Nyou-v2 .window[data-app-id="browser"].maximized .browser-app,
            body.Nyou-v2 .window[data-app-id="browser"].maximized .browser-content {
                border-radius: 0 !important;
            }

            body.Nyou-v2 .window[data-app-id="browser"] .browser-app {
                border-radius: 0 0 var(--browser-float-radius) var(--browser-float-radius);
                overflow: hidden;
                background: rgba(249, 249, 249, 0.78);
            }

            body.Nyou-v2.dark-mode .window[data-app-id="browser"] .browser-app {
                background: rgba(34, 34, 34, 0.78);
            }

            body.Nyou-v2 .window[data-app-id="browser"] .browser-header {
                margin: 0;
                border: 1px solid rgba(0, 0, 0, 0.06);
                border-top: none;
                border-radius: 0;
            ...
            body.Nyou-v2.dark-mode .window[data-app-id="browser"] .browser-header {
                border-color: rgba(255, 255, 255, 0.08) !important;
                background: rgba(34, 34, 34, 0.78) !important;
            }

            body.Nyou-v2 .window[data-app-id="browser"] .browser-titlebar-tabs-host {
                margin-left: 16px;
            }

            body.Nyou-v2 .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tab {
                background: rgba(255, 255, 255, 0.1);
                border: 1px solid rgba(255, 255, 255, 0.04);
            }

            body.Nyou-v2 .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tab:hover {
                background: rgba(255, 255, 255, 0.14);
            }

            body.Nyou-v2 .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tab.active {
            ...
            body.Nyou-v2 .window[data-app-id="browser"] .browser-titlebar-tabs .Nyou-tabbar-add,
            body.Nyou-v2 .window[data-app-id="browser"] .browser-nav-btn,
            body.Nyou-v2 .window[data-app-id="browser"] .browser-tool-btn {
                border-radius: 999px;
            }

            body.Nyou-v2 .window[data-app-id="browser"] .browser-address-bar {
            ...
            body.Nyou-v2 .window[data-app-id="browser"] .browser-content {
                background: transparent;
                border-radius: 0 0 var(--browser-float-radius) var(--browser-float-radius);
                overflow: hidden;
            }
