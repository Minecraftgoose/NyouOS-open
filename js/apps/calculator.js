...
const CalculatorApp = {
    ...
    renderSettingsPage(pageEl) {
        ...
        if (modeHost && window.NyouUI && typeof NyouUI.Select === 'function') {
            modeHost.appendChild(NyouUI.Select({
                value: defaultMode,
        ...
        if (toggleHost && window.NyouUI && typeof NyouUI.Toggle === 'function') {
            toggleHost.appendChild(NyouUI.Toggle({
                checked: keepHistory,
        ...
        if (clearHost && window.NyouUI && typeof NyouUI.Button === 'function') {
            clearHost.appendChild(NyouUI.Button({
    ...
    addStyles() {
        ...
        style.textContent = `
            ...
            .calculator-settings-select.Nyou-select-wrapper {
                width: 174px;
                min-width: 174px;
                z-index: 12;
            }

            .calculator-settings-toggle.Nyou-toggle-wrapper {
                flex: 0 0 auto;
            }
            ...
            .calculator-clear-history-button.nyou-btn {
                min-height: 36px;
            }
